        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900 shadow-md">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <NuxtLink to="/" class="flex items-center">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Book Manager</span>
                </NuxtLink>
                <div class="flex items-center md:order-2">
                    <button type="button"
                        ...
                        <img class="w-8 h-8 rounded-full" src="https://www.citypng.com/public/uploads/preview/free-round-flat-male-portrait-avatar-user-icon-png-11639648873oplfof4loj.png" alt="user photo">
                    </button>
                    <!-- Dropdown menu -->
